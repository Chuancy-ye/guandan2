...
# Form implementation generated from reading ui file 'import_table.ui'
#
...
class Ui_name(object):
    ...
    def retranslateUi(self, name):
        ...
        self.pushButton_2.setText(_translate("name", "开始比赛"))
        self.commandLinkButton.setText(_translate("name", "EXCEL导入"))
